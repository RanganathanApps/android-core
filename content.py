...
CONTENT = [
  ...
  'topics': [{'title': 'Coroutines Deep Dive',
              ...
              'content_sections': [{'heading': 'Core Concepts',
                                   ...
                                   {'heading': 'When to Use Each Dispatcher',
                                    'points': [],
                                    'subtopics': [{'title': 'Dispatchers.IO',
             ...
             {'title': 'Flow Advanced Patterns',
              ...
              'content_sections': [{'heading': 'Key Flow Operators',
                                    'points': ['collectAsStateWithLifecycle - auto-cancels when '
                                               ...
                                               'input changes',
                                               'retryWhen - exponential backoff for network '
                                               'failures']},
                                   {'heading': 'Flow Types Comparison',
                                    'points': [],
                                    'subtopics': [{'title': 'StateFlow',
             ...
             {'title': 'Kotlin Language Features',
              ...
              'content_sections': [{'heading': 'Key Areas',
                                    'subtopics': [{'title': 'Sealed Classes',
             ...
             {'title': 'Kotlin Essentials for Android',
              ...
              'content_sections': [{'heading': 'Null Safety',
                                    'points': ['• Nullable types: String? vs String',
                                               '• Safe call operator: obj?.method()',
                                               '• Elvis operator: val name = user?.name ?: '
                                               '"Unknown"',
                                               '• !! operator: forces non-null (use sparingly)',
                                               '• let, run, with, apply, also scope functions']},
                                   {'heading': 'Coroutines',
                                    'points': ['• Lightweight threads for asynchronous programming',
                                               ...
                                               '• Example:']},
                                   {'heading': 'Flow',
                                    'points': ['• Asynchronous data stream',
                                   ...
                                   {'heading': 'Extension Functions',
                                    'points': ['• Add functions to existing classes without '
                                               'inheritance',
                                               '• fun String.toTitleCase() = this.split(" '
                                               '").joinToString...']},
                                   {'heading': 'Data Classes',
                                    'points': ['• Auto-generates equals(), hashCode(), toString(), '
                                               'copy()',
                                               '• data class User(val id: Int, val name: String)',
                                               '• Ideal for models and DTOs']},
                                   {'heading': 'Sealed Classes',
                                    'points': ['• Restricted class hierarchies',
             ...
             {'title': 'Java Key Concepts',
              ...
              'description': 'Covers the Java foundations that still matter when working in mixed '
                             ...
                             'runtime behavior.',
              'content_sections': [{'heading': 'Garbage Collection',
                                    'points': ['• Automatic memory management',
                                               '• Generational GC: Young, Old, Permanent '
                                               'generations',
                                               '• Avoid memory leaks: static references, '
                                               'listeners, handlers']},
                                   {'heading': 'Concurrency (pre-Kotlin)',
                                    'points': ['• Thread, Runnable, Executor framework',
 ...
 {'id': 'ui-toolkit-views-jetpack-compose',
  ...
  'topics': [{'title': 'Compose Internals',
              ...
              'content_sections': [{'heading': 'Performance Optimization',
                                    'points': ['@Stable and @Immutable annotations tell Compose a '
                                   ...
                                   {'heading': 'Common Pitfalls',
                                    'points': [],
                                    'subtopics': [{'title': 'Lambda Recreation',
             ...
             {'title': 'Compose UI Patterns',
              ...
              'content_sections': [{'heading': 'Advanced UI Techniques',
                                    'points': [],
                                    'subtopics': [{'title': 'Custom Layouts',
             ...
             {'title': 'Animations in Compose',
              ...
              'description': "Compose provides a powerful animation system that's declarative and "
                             ...
                             'experiences.',
              'content_sections': [{'heading': 'Animation APIs Overview',
                                    'points': [],
                                    'subtopics': [{'title': 'AnimatedVisibility',
             ...
             {'title': 'Traditional View System',
              ...
              'content_sections': [{'heading': 'Layout Types',
                                   ...
                                   {'heading': 'Custom Views',
                                    'points': ['• Extend View or ViewGroup',
             ...
             {'title': 'Jetpack Compose (Modern UI)',
              ...
              'content_sections': [{'heading': 'Core Principles',
                                    'points': ['• Declarative UI: describe what UI should look '
                                               'like',
                                               '• Composable functions: @Composable annotation',
                                               '• Recomposition: UI updates when state changes',
                                               '• State hoisting: move state to caller for '
                                               'reusability']},
                                   {'heading': 'State Management',
                                    'points': ['• remember: preserves state across recompositions',
                                               '• rememberSaveable: survives configuration changes',
                                               '• mutableStateOf: observable state',
                                               '• collectAsState(): observe Flow/StateFlow',
                                               '• derivedStateOf: computed state']},
                                   {'heading': 'Layouts',
                                    'points': ['• Column, Row, Box (fundamental layouts)',
  ...
  'topics': [
             ...
             {'title': 'Compose Navigation',
              ...
              'content_sections': [{'heading': 'Key Points',
                                    'points': ['Use sealed classes for routes - compile-time '
                                               'safety',
                                               'NavBackStackEntry saves state when navigating - no '
                                               'data loss on back',
                                               'Use hiltNavGraph() for DI integration in '
                                               'navigation']}],
              'code_blocks': [{'language': 'kotlin',
  ...
  'topics': [{'title': 'Hilt Deep Dive',
              ...
              'content_sections': [{'heading': 'Scope Types',
                                   ...
                                   {'heading': 'Key Concepts',
                                    'points': [],
                                    'subtopics': [{'title': 'Component Hierarchy',
             ...
             {'title': 'Koin',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Lightweight, Kotlin-first DI framework • No code '
             ...
             {'title': 'Manual Dependency Injection',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Service locator pattern • Constructor injection '
 ...
 {'id': 'data-management-persistence',
  ...
  'topics': [{'title': 'Room Database',
             ...
             {'title': 'SharedPreferences',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Key-value storage for simple data • Stores '
             ...
             {'title': 'Repository Pattern',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Single source of truth for data • Abstracts data '
 ...
 {'id': 'networking-apis',
  ...
  'topics': [{'title': 'Retrofit & OkHttp',
             ...
             {'title': 'WebSockets',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Full-duplex communication • OkHttp WebSocket '
             ...
             {'title': 'API Response Handling',
              ...
              'content_sections': [{'heading': 'Result/Resource Pattern', 'points': []},
                                   {'heading': 'Error Handling',
                                    'points': ['• Network errors (no connectivity)',
                                               '• HTTP errors (4xx, 5xx)',
                                               '• Parsing errors',
                                               '• Timeout errors',
 ...
 {'id': 'concurrency-threading-background-work',
  ...
  'topics': [{'title': 'WorkManager',
              'icon': '',
              'description': 'Explains the recommended API for deferrable and reliable background '
                             'execution under Android power-management constraints.',
              'content_sections': [{'heading': 'Key Points',
                                    'points': ['WorkManager handles device restart, battery '
                                               'optimization, API level differences',
                                               'Use setExpedited() for urgent tasks (requires '
                                               'override to be async)',
                                               'Chain work with beginWith() then() for '
                                               'dependencies']}],
              'code_blocks': [{'language': 'kotlin',
             ...
             {'title': 'Thread Safety',
              ...
              'description': 'Covers race conditions, shared mutable state, and the '
                             ...
                             'coroutine basics.',
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• @Volatile annotation for visibility • Atomic '
 ...
 {'id': 'testing-strategy',
  ...
  'topics': [{'title': 'Unit Testing',
              ...
              'content_sections': [{'heading': 'JUnit & Mockito',
                                    'points': ['• JUnit 4 or JUnit 5 (Jupiter)',
             ...
             {'title': 'Instrumentation Testing',
              ...
              'content_sections': [{'heading': 'Espresso (UI Testing)',
                                    'points': ['• onView(): find view',
                                               '• perform(): perform action (click, typeText, '
                                               'swipe)',
                                               '• check(): verify view state',
                                               '• IdlingResource for async operations',
                                               '• RecyclerView actions and assertions']},
                                   {'heading': 'UI Automator',
                                    'points': ['• Cross-app interactions',
                                               '• System UI testing',
                                               '• UiDevice, UiObject, UiSelector']},
                                   {'heading': 'Room Testing',
                                    'points': ['• In-memory database for tests',
                                               '• Room.inMemoryDatabaseBuilder()',
                                               '• Test migrations']}],
              'code_blocks': []},
             {'title': 'Test Architecture',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Test Pyramid: More unit tests, fewer UI tests • '
  ...
  'topics': [{'title': 'App Startup Optimization',
             ...
             {'title': 'Modern Android Summary',
              ...
              'description': 'Explains modern android summary in the context of performance & '
                             ...
                             'modern standard.',
              'content_sections': [{'heading': 'Key Points',
                                    'points': ['Kotlin + Coroutines + Flow for async - modern '
                                               'standard',
                                               'Jetpack Compose for UI - declarative, less code, '
                                               'better performance',
                                               'Hilt for DI - compile-time safety, automatic '
                                               'cleanup',
             ...
             {'title': 'Memory Management',
              ...
              'content_sections': [{'heading': 'Memory Leaks',
                                    'points': ['• Common causes:',
                                               ...
                                               '• Prevention: WeakReference, proper lifecycle '
                                               'handling']},
                                   {'heading': 'Memory Optimization',
                                    'points': ['• Bitmap management: inSampleSize, recycle()',
             ...
             {'title': 'UI Performance',
              ...
              'content_sections': [{'heading': 'Layout Performance',
                                    'points': ['• Flatten view hierarchy with ConstraintLayout',
                                   ...
                                   {'heading': 'Rendering Performance',
                                    'points': ['• 16ms per frame for 60fps (jank threshold)',
                                   ...
                                   {'heading': 'Compose Performance',
                                    'points': ['• Minimize recomposition scope',
             ...
             {'title': 'Battery Optimization',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Doze mode and App Standby • Battery Historian '
             ...
             {'title': 'APK Size Optimization',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• ProGuard/R8 for code shrinking • Resource '
 ...
 {'id': 'security-privacy-app-integrity',
  ...
  'topics': [{'title': 'Secure Storage',
             ...
             {'title': 'Data Security',
              ...
              'content_sections': [{'heading': 'Encrypted Storage',
                                    'points': ['• EncryptedSharedPreferences for sensitive '
                                               'key-value data',
                                               '• SQLCipher for database encryption',
                                               '• Android Keystore for cryptographic keys',
                                               '• BiometricPrompt for user authentication']},
                                   {'heading': 'Network Security',
                                    'points': ['• HTTPS only, no HTTP',
             ...
             {'title': 'Authentication & Authorization',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• OAuth 2.0 / OpenID Connect • JWT tokens with '
             ...
             {'title': 'Permissions',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Request minimum permissions needed • Runtime '
 ...
 {'id': 'build-release-ci-cd',
  ...
  'topics': [{'title': 'GitHub Actions for Android',
             ...
             {'title': 'Continuous Integration',
              ...
              'content_sections': [{'heading': 'CI Platforms',
                                    'points': ['• GitHub Actions',
                                               '• GitLab CI',
                                               '• Jenkins',
                                               '• CircleCI',
                                               '• Bitrise']},
                                   {'heading': 'Pipeline Stages',
                                    'points': ['• Code checkout',
                                               '• Build',
                                               '• Unit tests',
             ...
             {'title': 'Continuous Deployment',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Fastlane for automation • Google Play Console '
             ...
             {'title': 'App Signing',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Debug keystore for development • Release '
  ...
  'topics': [{'title': 'ML Kit',
             ...
             {'title': 'KMP Fundamentals',
              ...
              'description': 'Explains kmp fundamentals in the context of advanced modern android '
                             ...
                             'implementations.',
              'content_sections': [{'heading': 'Key Points',
                                    'points': ['expect/actual pattern for platform-specific '
                                               'implementations',
                                               'Ktor for multiplatform HTTP, SQLDelight for '
                                               'database',
             ...
             {'title': 'Modern Android Development',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Kotlin Multiplatform Mobile (KMM) • Jetpack '
             ...
             {'title': 'Firebase Services',
              ...
              'description': 'Summarizes the Firebase tools most often used to add messaging, '
                             ...
                             'apps.',
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Firebase Cloud Messaging (FCM) • Firebase Remote '
             ...
             {'title': 'Android App Links & Deep Linking',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Intent filters for custom schemes • Android App '
             ...
             {'title': 'Accessibility',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Content descriptions for screen readers • '
             ...
             {'title': 'Localization & Internationalization',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• strings.xml for different locales • RTL '
             ...
             {'title': 'Google Play Store',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• App listing optimization (ASO) • Screenshot and '
 ...
 {'id': 'system-design-for-mobile',
  ...
  'topics': [{'title': 'Mobile System Design Principles',
              'icon': '',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Offline-first architecture • Local database as '
             ...
             {'title': 'Common Design Scenarios',
              ...
              'content_sections': [{'heading': 'News Feed App',
                                    'points': ['• Pagination with paging 3 library',
                                               '• Pull-to-refresh',
                                   ...
                                   {'heading': 'Chat Application',
                                    'points': ['• WebSocket for real-time messaging',
                                   ...
                                   {'heading': 'E-commerce App',
                                    'points': ['• Product catalog with search and filters',
                                   ...
                                   {'heading': 'Ride-sharing App',
                                    'points': ['• Real-time location tracking',
             ...
             {'title': 'Scalability Considerations',
              ...
              'description': 'Highlights the scale-related concerns that influence mobile '
                             ...
                             'caching.',
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• API versioning strategy • Backward compatibility '
 ...
 {'id': 'leadership-behavioral-questions',
  ...
  'topics': [{'title': 'Technical Leadership',
              'icon': '',
              ...
              'content_sections': [{'heading': 'Common Questions',
                                    'points': ['• How do you mentor junior developers?',
                                               ...
                                               '• Describe a complex technical problem you '
                                               'solved']},
                                   {'heading': 'Key Points to Cover',
                                    'points': ['• Collaboration with product and design teams',
             ...
             {'title': 'Project Management',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• How do you estimate tasks? • Tell me about a '
             ...
             {'title': 'Problem-Solving Approach',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Describe your debugging process • How do you '
             ...
             {'title': 'STAR Method for Behavioral Questions',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['S - Situation: Set the context T - Task: Describe '
             ...
             {'title': 'Cultural Fit Questions',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Why do you want to work for our company? • What '
 ...
 {'id': 'interview-preparation-strategy',
  ...
  'topics': [{'title': 'Before the Interview',
              'icon': '',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ["• Research the company's Android apps • Review "
             ...
             {'title': 'During the Interview',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Think aloud - explain your reasoning • Ask '
             ...
             {'title': 'Common Coding Questions',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Implement a custom View • Create a simple cache '
             ...
             {'title': 'Questions to Ask Interviewer',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• What does your typical sprint look like? • How '
             ...
             {'title': 'Overview',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['This comprehensive guide covers the essential '
 ...
 {'id': 'resources-references',
  ...
  'topics': [{'title': 'Official Documentation',
              'icon': '',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• developer.android.com - Official Android '
             ...
             {'title': 'Learning Platforms',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Android Developers Codelabs • Udacity Android '
             ...
             {'title': 'Communities',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Stack Overflow • Reddit: r/androiddev • Android '
             ...
             {'title': 'Recommended Books',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• "Android Programming: The Big Nerd Ranch Guide" '
             ...
             {'title': 'Tools & Libraries to Know',
              ...
              'content_sections': [{'heading': 'Highlights',
                                    'points': ['• Android Studio (IDE) • Postman (API testing) • '
